...
watch(searchQuery, (newVal) => {
  ...
  // Só scrolla para o topo dos itens se estivermos PESQUISANDO algo novo.
  // Se estivermos LIMPANDO (newVal vazio), mantemos a tela onde está para não dar o "salto" chato.
  if (newVal) {
    scrollToItemsTop()
  }
})
